...
const EducationCard: React.FC<EduCardProps> = ({ data }) => {
    return (
        <CardLayout className="keepItEmpty">
            <div className="card_stylings transition px-8 py-10">
                <div className="flex justify-between">
                    ...
                    <div className="flex justify-items-center justify-center text-LightGray bg-DeepNightBlack ml-2 w-32 lg:w-36 h-10 text-xs rounded-full py-3 font-normal opacity-50 text-center">
                        {data.year}
                    </div>
                </div>
